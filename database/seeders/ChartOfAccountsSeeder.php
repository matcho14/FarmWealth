...
class ChartOfAccountsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('chart_of_accounts')->insert([
            ...
            ['id' => 50, 'code' => 'feed_purchase', 'name' => 'مشتريات علف', 'parent_id' => 28, 'account_type' => 'expense', 'is_parent' => false, 'is_active' => true, 'opening_balance' => 0, 'shed_id' => null, 'linkable_type' => null, 'linkable_id' => null, 'created_at' => now(), 'updated_at' => now()],
            ['id' => 51, 'code' => 'medicine_purchase', 'name' => 'مشتريات أدوية', 'parent_id' => 28, 'account_type' => 'expense', 'is_parent' => false, 'is_active' => true, 'opening_balance' => 0, 'shed_id' => null, 'linkable_type' => null, 'linkable_id' => null, 'created_at' => now(), 'updated_at' => now()],
