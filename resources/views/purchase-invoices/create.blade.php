...
<div class="card">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0"><i class="fas fa-file-invoice me-2"></i>إنشاء فاتورة شراء جديدة</h5>
    </div>
    <div class="card-body">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-3">
                    ...
                    <input type="text" name="invoice_number" class="form-control @error('invoice_number') is-invalid @enderror"
                        value="{{ old('invoice_number', $nextNumber) }}" required>
                        ...
                        <table class="table table-bordered mb-0" id="itemsTable">
                            ...
                            <tbody id="itemsBody">
                                <tr class="item-row">
                                    ...
                                    <td><input type="number" name="items[0][quantity]" class="form-control form-control-sm qty-input" min="0.001" step="0.001" value="1" required></td>
                                    <td><input type="number" name="items[0][unit_price]" class="form-control form-control-sm price-input" min="0" step="0.01" value="0" required></td>
                                    <td class="text-center fw-bold line-total">0</td>
                                    <td class="text-center"><button type="button" class="btn btn-sm btn-danger remove-row" style="display:none"><i class="fas fa-times"></i></button></td>
                                </tr>
                            </tbody>
                            <tfoot>
                                <tr>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <input type="number" name="paid_amount" id="paid_amount" class="form-control"
                            min="0" step="0.01" value="{{ old('paid_amount',0) }}" placeholder="0">
                        <span class="input-group-text">ج.م</span>
                    </div>
                    <small class="text-muted">اتركه 0 إذا كان الشراء بالآجل</small>
                </div>
                <div class="col-md-4">
