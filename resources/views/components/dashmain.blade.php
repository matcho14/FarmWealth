                    ...
                    <ul class="vertical-menu">
                        <li>
                          <a href="{{ route('medicines.index') }}">
                             <i class="feather icon-package"></i><span>المخزن والأدوية</span>
                          </a>
                        </li>
                        <li>
                          <a href="javaScript:void();">
                             <img src="{{ asset('assets/images/svg-icon/dashboard.svg') }}" class="img-fluid" alt="dashboard"><span>لوحة التحكم</span><i class="feather icon-chevron-right"></i>
                          </a>
                            <ul class="vertical-submenu">

                                <li><a href="dashboard-school.html">لوحة التحكم</a></li>
                            </ul>
                        </li>
