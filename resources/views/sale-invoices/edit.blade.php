                ...
                <div class="col-md-6">
                    ...
                    <select name="cycle_id" class="form-select @error('cycle_id') is-invalid @enderror">
                        ...
                        @foreach($cycles as $cycle)
                            <option value="{{ $cycle->id }}" {{ old('cycle_id', $saleInvoice->cycle_id) == $cycle->id ? 'selected' : '' }}>{{ $cycle->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select name="shed_id" class="form-select @error('shed_id') is-invalid @enderror">
                        ...
                        @foreach($sheds as $shed)
                            <option value="{{ $shed->id }}" {{ old('shed_id', $saleInvoice->shed_id) == $shed->id ? 'selected' : '' }}>{{ $shed->name }}</option>
                        @endforeach
                    </select>
